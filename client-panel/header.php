...
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
    <title>Employee Crossing Client Panel</title>
    ...
    <link href="<?php echo SITE_BASE_URL; ?>css/custom.css" rel="stylesheet" type="text/css">
...
<div class="wrapper">
    ...
    -->
        ...
        <div class="sidebar-wrapper">
            ...
            <ul class="nav">
                <li class="active">
                    <a href="<?php echo SITE_BASE_URL; ?>client-panel/dashboard">
                        <i class="ti-panel"></i>
                        <p>Dashboard</p>
                    </a>
                </li>
                <li>
                    <a href="<?php echo SITE_BASE_URL; ?>client-panel/create-bgv-request">
                        <i class="ti-panel"></i>
                        <p>Create BGV Request</p>
                    </a>
                </li>
                <li>
                    <a href="<?php echo SITE_BASE_URL; ?>client-panel/complete-bgv-request">
                        <i class="ti-panel"></i>
                        <p>Completed BGV Request</p>
                    </a>
                </li>
                <li>
                    <a href="<?php echo SITE_BASE_URL; ?>client-panel/download-employee-report">
                        <i class="ti-user"></i>
                        <p>Download Employee Report</p>
                    </a>
                </li>
                <li>
                    <a href="<?php echo SITE_BASE_URL; ?>client-panel/raise-query">
                    ...
                    <ul class="nav navbar-nav navbar-right" >
                        <li class="dropdown">
                              <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="color:#FFF;">
                                    ...
                                    <p><?php echo $_SESSION['ecrossing_client_name']; ?></p>
                                    <b class="caret"></b>
                              </a>
                              <ul class="dropdown-menu" style="color:#FFF;">
                                ...
                                <li><a href="<?php echo SITE_BASE_URL."client-panel/logout.php" ?>">Logout</a></li>
                              </ul>
                        </li>
                    </ul>
