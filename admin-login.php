...
if(isset($_SESSION['ecrossing_admin_email'])) {
    header('Location: '.SITE_BASE_URL.'admin-panel/dashboard');
}
...
<html>
<head>
    <title>Ecrossing Admin Login</title>
...
<div class="main-container body">
    ...
    <form class="admin-login form">
        ...
        <button class="admin-login-btn" type="button" onclick="admin_login();">Login to Dashboard</button>
    </form>
  </div>
</div>
<body>
<script type="text/javascript">
$(".admin-login").keyup(function(event){
    if(event.keyCode == 13){
